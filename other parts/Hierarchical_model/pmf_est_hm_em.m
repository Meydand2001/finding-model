function [lambda,b_matrices,a_tensors,iter,log_likelihood] = pmf_est_hm_em(data_set,alphabet,g_alphabet,model_order,M,array_of_sizes,fld,epsilon,max_iterations)
